...
if World1 then
    ...
    bossdefault = {"The Saw"}
elseif World2 then
    bosspain = {"Diamond", "Jeremy", "Fajita", "Don Swan", "Smoke Admiral", "Cursed Captain", "Darkbeard", "Order", "Awakened Ice Admiral", "Tide Keeper"}
    bossdefault = {"Diamond"}
elseif World3 then
